...
class _MethodWidgetState extends State<MethodWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MethodModel());
  }
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/Enchanting_Nebula_Nights__High-Quality_Free_iPhone_Wallpaper_1.png',
                      ...
                      children: [
                        Align(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Video__Hubble_Reflects_the_Cosmos_1.png',
                              width: 357.0,
                              height: 189.0,
                              fit: BoxFit.cover,
                            ),
