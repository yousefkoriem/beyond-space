...
class _ClassificationWidgetState extends State<ClassificationWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassificationModel());
  }
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/Amazing_Astronomy__60_Of_The_Most_Captivating_Astronomy_Pictures_1.png',
                      ...
                      children: [
                        ...
                        wrapWithModel(
                          ...
                          child: EduContentBelowWidget(
                            ...
                            headText: 'How does NASA classify exoplanets?',
                          ),
                        ),
