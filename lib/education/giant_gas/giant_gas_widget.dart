...
import 'giant_gas_model.dart';
export 'giant_gas_model.dart';

class GiantGasWidget extends StatefulWidget {
  const GiantGasWidget({
    super.key,
    this.imgbg,
    this.head,
    this.edLink,
  ...
  @override
  State<GiantGasWidget> createState() => _GiantGasWidgetState();
}

class _GiantGasWidgetState extends State<GiantGasWidget> {
  late GiantGasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GiantGasModel());
  }
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/Brown_Space_Walpaper_1.png',
                      ...
                      children: [
                        Align(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Planeta_Jupiter_-_Astronomii_si_NASA_au_fost_ULUITI_de_o_Noua_Descoperire_1.png',
                              width: 357.0,
                              height: 189.0,
                              fit: BoxFit.cover,
                            ),
