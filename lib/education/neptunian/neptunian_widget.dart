...
import 'neptunian_model.dart';
export 'neptunian_model.dart';

class NeptunianWidget extends StatefulWidget {
  const NeptunianWidget({
    super.key,
    this.imgbg,
    this.head,
    this.edLink,
  ...
  @override
  State<NeptunianWidget> createState() => _NeptunianWidgetState();
}

class _NeptunianWidgetState extends State<NeptunianWidget> {
  late NeptunianModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NeptunianModel());
  }
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/download_(3)_1.png',
                      ...
                      children: [
                        Align(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/download_(10)_1.png',
                              width: 357.0,
                              height: 189.0,
                              fit: BoxFit.cover,
                            ),
                        ...
                        wrapWithModel(
                          ...
                          child: EduContentBelowWidget(
                            ...
                            vidlink:
                                'https://www.youtube.com/watch?v=11Ip3u30orQ',
